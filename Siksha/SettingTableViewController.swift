...
class SettingTableViewController: UITableViewController {
  ...
  override func viewWillAppear(animated: Bool) {
    NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(SettingTableViewController.onRefreshFinished), name: REFRESH_NOTIFICATION_KEY, object: nil)
  }
