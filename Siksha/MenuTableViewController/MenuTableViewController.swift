...
class MenuTableViewController: UITableViewController {
    ...
    @IBAction func bookmarkButtonClicked(sender: AnyObject) {
        ...
        if recordedBookmarks == "" {
            ...
            AppData.save(dataArray[rowIndex].restaurant, key: AppData.KEY_BOOKMARK)
        }
            ...
            AppData.save("\(recordedBookmarks)/\(dataArray[rowIndex].restaurant)", key: AppData.KEY_BOOKMARK)
        }
        else {
