...
class SequenceTableViewController: UITableViewController {
    ...
    @IBAction func editButtonClicked(sender: AnyObject) {
        ...
        if self.editing {
            ...
            if segueType == 0 {
                ...
                AppData.save(sequenceString, key: AppData.KEY_BOOKMARK)
            }
            else {
                Preference.save(sequenceString, key: Preference.PREF_KEY_SEQUENCE)
                AppData.save(sequenceString, key: AppData.KEY_SEQUENCE)
            }
        }
    ...
    override func tableView(tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        let headerCell = tableView.dequeueReusableCellWithIdentifier("SequenceTableViewHeaderCell") as! SequenceTableViewHeaderCell
